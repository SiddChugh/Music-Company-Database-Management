import pymssql
conn = pymssql.connect (host='cypress.csil.sfu.ca', user='', password='', database='sfu')
...
# Place triggers in place
fd = open('triggers.sql', 'r')
sqlFile = fd.read()
fd.close()
...
while(choice == "yes")
  ...
  choice = raw_input("Enter yes to enter more records")
